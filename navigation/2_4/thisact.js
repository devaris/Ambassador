...
var currTar = "";
var objPositions = {};
var dndCookie = 'AmbassadorEx2_4';
var cookieLifetime = 365;
var thenext = 1;
var allObg = 0;
var corrArray = [2,3,1,4];
...
$(document).ready(function() {	
	...
	drop: function(event, ui) {
		...
		if (corrArray[theDraggedId-1] == theTargetId) {
			...
			/*if(corrArray[theDraggedId-1] == corrArray[corrArray.length - 1])
			{$("#large5").show();}*/
			...
			//ALL ITEMS ARE DRAGGED AND COMPLETED
			if(allObg === 4){
				$("#large5").show();
				audioPlay("completed");
		...
		/*else if (corrArray[theDraggedId-1] == theTargetId && corrArray[theDraggedId-1] == corrArray[corrArray.length - 1])*/
