...
var currTar = "";
var objPositions = {};
var dndCookie = 'AmbassadorEx2_5';
var cookieLifetime = 365;
var thenext = 1;
var allObg = 0;
var corrArray = [2,1,3,4];
...
$(document).ready(function() {	
	...
	drop: function(event, ui) {
		...
		if (corrArray[theDraggedId-1] == theTargetId) {
			...
			$('#wrong'+($(this).index()+1)).css('visibility','hidden');
			$('#correct'+($(this).index()+1)).css('visibility','visible');
			//thenext++;
		...
		*/
			...
			audioWrong();
			$('#wrong'+($(this).index()+1)).css('visibility','visible');
